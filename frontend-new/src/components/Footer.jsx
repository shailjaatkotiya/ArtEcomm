...
const Footer = () => (
  <footer className="bg-ink text-ivory px-6 md:px-12 pt-16 pb-8">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 pb-12 border-b border-ivory/10">
        {/* Section 1 — Brand */}
        <div>
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <a href="#" className="font-light text-ivory/70 hover:text-ivory transition-colors">Newsletter</a>
        </div>
      </div>
